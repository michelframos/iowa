<ul class="nav pmd-sidebar-nav">
    ...
    -->
    <li> <a class="pmd-ripple-effect" id="menu-inicio" href="javascript:void(0);"><i class="material-icons media-left media-middle">home</i> <span class="media-body">Início</span></a> </li>
    <li> <a class="pmd-ripple-effect" id="menu-mensalidades" href="javascript:void(0);"><i class="material-icons media-left media-middle">confirmation_number</i> <span class="media-body">Mensalidade</span></a> </li>
</ul>
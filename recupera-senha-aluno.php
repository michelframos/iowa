<?php
    ...
    if(filter_input(INPUT_POST, 'enviar', FILTER_SANITIZE_STRING)):
        ...
        $data_nascimento = implode('-', array_reverse(explode('/', filter_input(INPUT_POST, 'data_nascimento', FILTER_SANITIZE_STRING))));
        $email = filter_input(INPUT_POST, 'email', FILTER_SANITIZE_EMAIL);
        if(empty($email) || empty($data_nascimento)):
            Mensagem('O preendimento da data de nascimento e email são obrigátorios', '');
            exit();
        endif;
    ...
    <article class="texto-centro box-recupera-senha bg-branco">
        ...
        <div class="padding-15">
            <form action="" name="formLogin" id="formLogin" method="post">
                ...
                <div class="espaco"></div>
                <input type="text" name="data_nascimento" id="data_nascimento" value="" placeholder="" class="campo-100 texto-centro">
                <div class="espaco20"></div>

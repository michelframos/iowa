    ...
    <div class="table-responsive">
        <table class="table pmd-table table-hover">
            ...
            <tr>
                ...
                <th>Unidade</th>
                <th width="250">CNPJ</th>
                <th width="100">Usar Dados Para Boletos</th>
            ...
            if(isset($_POST['valor'])):
                ...
                $registros = Unidades::all(array('conditions' => array($campo.' like ?', '%'.$valor.'%'), 'order' => 'nome_fantasia asc'));
                if(!empty($registros)):
                    foreach($registros as $registro):
                        ...
                        echo '<td data-title="Usar">';
                        echo '<div class="pmd-switch">';
                        echo '<label>';
                        echo $registro->usar_dados_boleto == 's' ? '<input type="checkbox" checked>' : '<input type="checkbox">';
                        echo '<span class="pmd-switch-label usar-dados-boleto" registro="'.$registro->id.'"></span>';
                        echo '</label>';
                        echo '</div>';
                        echo '</td>';

<?php
    ...
    $matriculas = Matriculas::find_all_by_id_aluno($aluno->id);
            ...
            <div id="ajustes-financeiros">
                ...
                <div id="box-empresa-financeiro">
                    ...
                    <div class="form-group pmd-textfield pmd-textfield-floating-label">
                        ...
                        <input type="text" name="porcentagem_empresa" id="porcentagem_empresa" value="0" class="form-control"><span class="pmd-textfield-focused"></span>
                    </div>
                </div>
            </div>


            <button type="button" name="salvar-parcela" id="salvar-parcela" value="Salvar" registro="<?php echo $aluno->id ?>" class="btn btn-info pmd-btn-raised">Salvar</button>
            <div class="espaco20"></div>

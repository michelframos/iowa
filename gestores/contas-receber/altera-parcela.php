...
<!-- Start Content -->
    ...
    <section class="pmd-card pmd-z-depth padding-10">
        ...
        <form action="" name="formDados" id="formDados" method="post" style="max-width: 800px;">
            ...
            <button type="submit" name="salvar-conta-receber" id="salvar-conta-receber" value="Salvar" registro="<?php echo $aluno->id ?>" parcela="<?php echo $parcela->id ?>" class="btn btn-info pmd-btn-raised">Salvar</button>
            <div class="espaco20"></div>

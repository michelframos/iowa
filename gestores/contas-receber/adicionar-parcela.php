<?php
    ...
    verificaPermissao(idUsuario(), 'Contas a Receber', 'i', 'index');
?>
...
<!-- Start Content -->
    ...
    <div class="titulo">
        ...
        <h1>Adicionar Parcela</h1>
    </div>

    <section class="pmd-card pmd-z-depth padding-10">

        <div class="espaco20"></div>
        <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="voltar-contas-receber" registro="<?php echo $aluno->id ?>">Voltar</a>
        <div class="espaco20"></div>
        ...
        <form action="" name="formDados" id="formDados" method="post" style="max-width: 800px;">
            ...
            <div class="float-left margin-right-5">
                <div class="form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">
                    ...
                    <select name="id_aluno" id="id_aluno" class="select-simple form-control pmd-select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" required>
                        <option>Selecione uma turma para mostrar os alunos</option>
            ...
            <button type="button" name="salvar-parcela-conta-receber" id="salvar-parcela-conta-receber" value="Salvar" registro="<?php echo $aluno->id ?>" class="btn btn-info pmd-btn-raised">Salvar</button>
            <div class="espaco20"></div>

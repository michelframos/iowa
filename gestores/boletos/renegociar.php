...
try{
    $opcoes_cobranca = Opcoes_Cobranca::find_by_id(1);
} catch(\ActiveRecord\RecordNotFound $e){
    $opcoes_cobranca = '';
}

$id_boleto = filter_input(INPUT_POST, 'boleto', FILTER_VALIDATE_INT);
...
try{
    ...
    $turma = Turmas::find_by_id($parcela->id_turma);
...
if($matricula->responsavel_financeiro == 2):
    $empresa = Empresas::find_by_id($matricula->id_empresa_financeiro);
endif;
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <form action="" name="formDados" id="formDados" method="post" style="max-width: 800px;">
        ...
        <div class="form-group pmd-textfield pmd-textfield-floating-label coluna-4 margin-right-10">
            ...
            <input type="text" disabled name="desconto" id="desconto" value="<?php echo number_format($parcela->desconto, 2, ',', '.') ?>" class="form-control"><span class="pmd-textfield-focused"></span>
        </div>
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <form action="" name="formNovosDados" id="formNovosDados" method="post" style="max-width: 800px;">
        ...
        <input type="hidden" name="id_boleto" id="id_boleto" value="<?php echo $boleto->id ?>">

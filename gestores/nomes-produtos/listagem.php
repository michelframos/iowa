    ...
    <div class="table-responsive">
        <table class="table pmd-table table-hover">
            ...
            if(isset($_POST['valor_pesquisa'])):
                ...
                $registros = Nomes_Produtos::all(array('conditions' => array('nome_material like ?', '%'.$valor_pesquisa.'%'), 'order' => 'nome_material asc'));
                if(!empty($registros)):
                    foreach($registros as $registro):
                        ...
                        echo '<td data-title="Horas Semais">'.$registro->horas_semanais.' Hora(s) Por Semana</td>';

<?php
    ...
    verificaPermissao(idUsuario(), 'Nomes de Produtos e Horas Semanais', 'c', 'index');
...
<div class="titulo">
    ...
    <h1>Nomes de Produtos e Horas Semanais</h1>
</div>
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <div class="espaco20"></div>
    <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-novo"> Novo Nome de Produto e Horas Semanais</a>
    <div class="espaco20"></div>

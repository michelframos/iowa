<?php
    ...
    verificaPermissao(idUsuario(), 'Programação e Conteúdo de Aulas', 'c', 'index');
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Confirma a exclusão desta Programação e Conteúdo de Aulas? Esta ação é irreversível! </p>
            </div>
...
<div class="titulo">
    ...
    <h1>Programação e Conteúdo de Aulas</h1>
</div>
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <div class="espaco20"></div>
    <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-novo"> Nova Programação e Conteúdo de Aulas</a>
    <div class="espaco20"></div>

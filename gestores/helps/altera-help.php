    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="pmd-card-title-text">Horário Preenchido</h2>
            </div>
            <div class="modal-body">
                <p>Já exite um Help com este instrutor para a data <span id="data-help"></span>.</p>
            </div>
...
<div class="titulo">
    <i class="material-icons texto-laranja pmd-md">help</i>
    <h1> Cadastro / Alteração de HELP</h1>
</div>
    ...
    <div class="pmd-card pmd-z-depth">
        <div class="pmd-tabs pmd-tabs-bg">
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#dados-help" aria-controls="home" role="tab" data-toggle="tab">Dados do HELP</a></li>
            </ul>
        </div>
        ...
        <div class="pmd-card-body">
            <div class="tab-content">
                ...
                <!-- --------------------------------------------------------------------------------------- -->
                <!-- Conteúdo de Uma Aba -->
                <div role="tabpanel" class="tab-pane active" id="dados-help">
                    ...
                    <form action="" name="formDados" id="formDados" method="post" style="max-width: 800px;">
                        ...
                        <div style="max-width: 800px;">
                            ...
                            <div class="form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">
                                ...
                                <select name="id_empresa" id="id_empresa" class="select-simple form-control pmd-select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                    <option></option>
                                    <?php
                                    $empresas = Empresas::all(array('conditions' => array('status = ? or id = ?', 'a', $registro->id_empresa), 'order' => 'nome_fantasia asc'));
                                    if(!empty($empresas)):
                                        foreach($empresas as $empresa):
                                            echo $registro->id_empresa == $empresa->id ? '<option selected value="'.$empresa->id.'">'.$empresa->nome_fantasia.'</option>' : '<option value="'.$empresa->id.'">'.$empresa->nome_fantasia.'</option>';
                                        endforeach;
                                    endif;
                                    ?>
                                </select>
                            ...
                            <div class="form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed">
                                <label>Tipo de HELP</label>
                                <select name="tipo_help" id="tipo_help" class="select-simple form-control pmd-select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true" required>
                                    <option value=""></option>
                                    <option <?php echo $registro->tipo_help == 'help' ? 'selected' : ''; ?> value="help">HELP</option>
                                    <option <?php echo $registro->tipo_help == 'help fixo' ? 'selected' : ''; ?> value="help fixo">HELP FIXO</option>
                                    <option <?php echo $registro->tipo_help == 'speed class' ? 'selected' : ''; ?> value="speed class">SPEED CLASS</option>
                                </select>
                                <span class="select2 select2-container select2-container--bootstrap select2-container--open select2-container--focus select2-container--above" dir="ltr" style="width: 236px;"><span class="selection"><span class="select2-selection select2-selection--single" role="combobox" aria-haspopup="true" aria-expanded="true" tabindex="0" aria-labelledby="select2-akzg-container" aria-owns="select2-akzg-results" aria-activedescendant="select2-akzg-result-uq2y-Detroit Lions"><span class="select2-selection__rendered" id="select2-akzg-container" title=""></span><span class="select2-selection__arrow" role="presentation"><b role="presentation"></b></span></span></span><span class="dropdown-wrapper" aria-hidden="true"></span></span><span class="pmd-textfield-focused"></span>
                            </div>
                        ...
                        <div class="form-group pmd-textfield pmd-textfield-floating-label">
                            <label for="regular1" class="control-label">Quantidade de HELPs</label>
                            <input type="text" name="quantidade_helps" id="quantidade_helps" value="<?php echo $registro->quantidade_helps; ?>" class="form-control" required><span class="pmd-textfield-focused"></span>
                        </div>

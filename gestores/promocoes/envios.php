...
<div tabindex="-1" class="modal fade" id="envio-erro-cupons-dialog" style="display: none;" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="pmd-card-title-text">Erro ao enviar</h2>
            </div>
            <div class="modal-body">
                <p>Esta promoção já atingiu o número máximo de cupons.</p>
            </div>
            <div class="pmd-modal-action pmd-modal-bordered text-right">
                <button data-dismiss="modal" class="btn pmd-btn-raised pmd-ripple-effect btn-danger" type="button">OK</button>
            </div>
...
<script src="js/envios-promocao.js"></script>

<!-- Start Content -->
<div class="espaco20"></div>
<div class="titulo">
    <i class="material-icons texto-laranja pmd-md">description</i>
    <h1>Envio de Promoção para alunos</h1>
</div>

<section class="pmd-card pmd-z-depth padding-10">

    <input type="hidden" name="id_promocao" id="id_promocao" value="<?php echo $promocao->id ?>"/>
    ...
    <form action="" name="formPesquisa" id="formPesquisa" method="post">
        ...
        <div class="form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed coluna-4">
            ...
            <select name="status_aluno" id="status_aluno" class="select-simple form-control pmd-select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true">
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <form action="" method="post" name="formMensagem" id="formMensagem" enctype="multipart/form-data">
        ...
        <div class="form-group pmd-textfield pmd-textfield-floating-label">
            <textarea class="form-control" name="mensagem" id="mensagem" rows="15" placeholder="Digite aqui sua mensagem" readonly><?php echo $promocao->mensagem ?></textarea>
        </div>
...
<div class="oculto" id="ms-envio-erro-cupons-dialog" data-target="#envio-erro-cupons-dialog" data-toggle="modal"></div>

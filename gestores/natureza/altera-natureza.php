<?php
    ...
    $registro = Natureza_Conta::find($id);
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Já existe uma Natureza de Conta a Pagar com este nome.</p>
            </div>
...
<!-- Start Content -->
    ...
    <div class="titulo">
        ...
        <h1>Cadastro / Alteração de Natureza de Conta a Pagar</h1>
    </div>
    ...
    <section class="pmd-card pmd-z-depth padding-10">
        ...
        <form action="" name="formDados" id="formDados" method="post" style="max-width: 600px;">
            ...
            <div class="form-group pmd-textfield pmd-textfield-floating-label">
                <label for="regular1" class="control-label">Natureza</label>
                <input type="text" name="natureza" id="natureza" value="<?php echo $registro->natureza; ?>" class="form-control"><span class="pmd-textfield-focused"></span>
            </div>

<?php
    ...
    verificaPermissao(idUsuario(), 'Natureza de Contas a Pagar', 'c', 'index');
?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Confirma a exclusão desta Natureza de Contas a Pagar? Esta ação é irreversível! </p>
            </div>
...
<!-- Start Content -->
    ...
    <div class="titulo">
        ...
        <h1>Natureza de Contas a Pagar</h1>
    </div>
    ...
    <section class="pmd-card pmd-z-depth padding-10">
        ...
        <div class="espaco20"></div>
        <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-novo"> Nova Natureza de Conta a Pagar</a>
        <div class="espaco20"></div>

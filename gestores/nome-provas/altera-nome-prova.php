...
<script src="js/nome-provas.js"></script>

<!-- Start Content -->
    <div class="espaco20"></div>
    <div class="titulo">
        <i class="material-icons texto-laranja pmd-md">content_paste</i>
        <h1>Cadastro / Alteração de Nome de Prova</h1>
    </div>

    <section class="pmd-card pmd-z-depth padding-10">

        <div class="espaco20"></div>
        <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-voltar-nome-provas">Voltar</a>
        <div class="espaco20"></div>
        ...
        <form action="" name="formDados" id="formDados" method="post" style="max-width: 600px;">
            ...
            <div class="form-group pmd-textfield pmd-textfield-floating-label">
                <label for="regular1" class="control-label">Nome da Prova</label>
                <input type="text" name="nome-prova" id="nome-prova" value="<?php echo $registro->nome; ?>" class="form-control"><span class="pmd-textfield-focused"></span>
            </div>

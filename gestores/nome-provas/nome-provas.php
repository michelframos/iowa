<?php
    ...
    verificaPermissao(idUsuario(), 'Nomes de Provas', 'c', 'index');
?>
...
<!-- Start Content -->
    ...
    <section class="pmd-card pmd-z-depth padding-10">
        ...
        <div class="espaco20"></div>
        <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-novo-nome-prova"> Novo Nome de Prova</a>
        <div class="espaco20"></div>

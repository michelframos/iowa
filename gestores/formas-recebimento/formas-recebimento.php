<?php
    ...
    verificaPermissao(idUsuario(), 'Formas de Recebimento/Pagamento', 'c', 'index');
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Confirma a exclusão desta Forma de Recebimento? Esta ação é irreversível! </p>
            </div>
...
<!-- Start Content -->
    ...
    <div class="titulo">
        ...
        <h1>Formas de Recebimento/Pagamento</h1>
    </div>
    ...
    <section class="pmd-card pmd-z-depth padding-10">
        ...
        <div class="espaco20"></div>
        <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-novo"> Nova Forma de Recebimento/Pagamento</a>
        <div class="espaco20"></div>

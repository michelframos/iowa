<?php
    ...
    verificaPermissao(idUsuario(), 'Editor de Documentos', 'c', 'index');
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Confirma a exclusão deste texto? Esta ação é irreversível! </p>
            </div>
...
<!-- Start Content -->
    ...
    <section class="pmd-card pmd-z-depth padding-10">
        ...
        <div class="espaco20"></div>
        <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-novo"> Novo Texto</a>
        <div class="espaco20"></div>

<?php
    ...
    verificaPermissao(idUsuario(), 'Valores Hora/Aula', 'c', 'index');
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <div class="espaco20"></div>
    <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-novo"> Novo Valor Hora/Aula</a>
    <div class="espaco20"></div>

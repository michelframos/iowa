...
$registro = Valores_Hora_Aula::find($id);
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Já exite um Uma Empresa/Unidade com este nome.</p>
            </div>
...
<div class="titulo">
    ...
    <h1>Cadastro / Alteração de Valor Hora/Aula</h1>
</div>
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <form action="" name="formDados" id="formDados" method="post" style="max-width: 600px;">
        ...
        <div class="form-group pmd-textfield pmd-textfield-floating-label">
            <label for="regular1" class="control-label">Empresa/Unidade</label>
            <input type="text" name="nome" id="nome" value="<?php echo $registro->nome ?>" class="form-control"><span class="pmd-textfield-focused"></span>
        </div>

        <div class="form-group pmd-textfield pmd-textfield-floating-label">
            <label for="regular1" class="control-label">Valor Hora/Aula</label>

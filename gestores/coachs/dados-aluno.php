...
$id_turma_selecionada = filter_input(INPUT_POST, 'turma', FILTER_VALIDATE_INT);
...
<a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="voltar-turma">Voltar</a>
<div class="espaco20"></div>
...
<div class="pmd-card pmd-z-depth padding-10">
    ...
    <div id="listagem-atas">
        <?php include_once('listagem-atas.php'); ?>
    </div>
    <?php endif; ?>

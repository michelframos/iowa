<?php
    ...
    verificaPermissao(idUsuario(), 'Origem do Aluno', 'c', 'index');
?>

<script src="js/origem-aluno.js"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Confirma a exclusão desta Origem do Aluno? Esta ação é irreversível! </p>
            </div>
...
<!-- Start Content -->
    ...
    <div class="titulo">
        <i class="material-icons texto-laranja pmd-md">add_location</i>
        <h1>Origem do Aluno</h1>
    </div>
    ...
    <section class="pmd-card pmd-z-depth padding-10">
        ...
        <div class="espaco20"></div>
        <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-novo"> Nova Origem do Aluno</a>
        <div class="espaco20"></div>

    ...
    <section class="pmd-card pmd-z-depth padding-10">
        ...
        <form action="" name="formDados" id="formDados" method="post" style="max-width: 800px;">
            ...
            <div class="form-group pmd-textfield pmd-textfield-floating-label float-left">
                ...
                <input type="text" name="valor" id="valor" value="<?php echo number_format($registro->valor, 2, ',', '.'); ?>" class="form-control"><span class="pmd-textfield-focused"></span>
            </div>
            <div class="clear"></div>
            ...
            <div class="form-group pmd-textfield pmd-textfield-floating-label">
                ...
                <textarea name="observacoes" id="observacoes" class="form-control"><?php echo $registro->descricao ?></textarea>
            </div>
            <div class="clear"></div>

            <button type="submit" name="alterar" id="alterar" value="Salvar" registro="<?php echo $registro->id ?>" class="btn btn-info pmd-btn-raised">Salvar</button>
            <div class="espaco20"></div>

...
<div class="pmd-card">
    <div class="table-responsive">
        <table class="table pmd-table table-hover">
            ...
            if(!empty($data_inicial) and (!empty($data_final))):
                $registros = Contas_Pagar::all(array('conditions' => array('(data_vencimento between ? and ?) and id_categoria like ? and id_natureza like ? and id_fornecedor like ? and id_unidade like ? and pago = ?', $data_inicial, $data_final, $id_categoria, $id_natureza, $id_fornecedor, $id_unidade, 's'),'order' => 'data_vencimento asc'));
            else:
                $registros = Contas_Pagar::all(array('conditions' => array('id_categoria like ? and id_natureza like ? and id_fornecedor like ? and id_unidade like ? and pago = ?', $id_categoria, $id_natureza, $id_fornecedor, $id_unidade, 's'),'order' => 'data_vencimento asc'));
            endif;

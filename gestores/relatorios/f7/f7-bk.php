<?php
    ...
    verificaPermissao(idUsuario(), 'Relatório - F7', 'c', 'index');
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <form action="" name="formPesquisa" id="formPesquisa" method="post">
        ...
        <!--
        <div class="form-group pmd-textfield pmd-textfield-floating-label float-left coluna-3">
            <label for="regular1" class="control-label">Considerar abono como presença</label>
            <select name="considerar_abono" id="considerar_abono" class="select-simple form-control pmd-select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true">
        ...
        <?php if(Permissoes::find_by_id_usuario_and_tela_and_imp(idUsuario(), 'Relatório - Frequencia', 's')): ?>

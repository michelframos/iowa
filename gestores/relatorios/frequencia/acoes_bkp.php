    ...
    if(!empty($turmas)):
        ...
        foreach($turmas as $turma):
            ...
            if(empty($data_final)):
                ...
                $aulas = Aulas_Turmas::all(array('conditions' => array('id_turma = ? and (id_situacao_aula <> ? and id_situacao_aula <> 2 and id_situacao_aula <> 3 and id_situacao_aula <> 5 and id_situacao_aula <> 10) and (data between ? and ?)', $turma->id, 0, $data_inicial, $data_final)));
            endif;

<?php
    ...
    //verificaPermissao(idUsuario(), 'Relatório - Aniversariantes', 'c', 'index');

?>
<script src="js/jQuery.print.min.js"></script>
<script src="js/rel-logins.js"></script>

<!-- Start Content -->
<div class="espaco20"></div>
<div class="titulo">
    <i class="material-icons texto-laranja pmd-md">description</i>
    <h1>Relatório de Logins dos Alunos</h1>
</div>
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <form action="" name="formPesquisa" id="formPesquisa" method="post">
        ...
        <div class="form-group pmd-textfield pmd-textfield-floating-label pmd-textfield-floating-label-completed coluna-3">
            <label>Somente Duplicados</label>
            <select name="duplicados" id="duplicados" class="select-simple form-control pmd-select2 select2-hidden-accessible" tabindex="-1" aria-hidden="true">
        ...
        <?php //if(Permissoes::find_by_id_usuario_and_tela_and_imp(idUsuario(), 'Relatório - Aniversariantes', 's')): ?>

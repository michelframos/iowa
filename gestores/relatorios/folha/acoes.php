                    ...
                    if(!empty($aulas)):
                        ...
                        foreach($aulas as $aula):
                            ...
                            echo '<tr>';
                                ...
                                echo '<td class="text-center" width="20%">'.$aula->conteudo_dado.'-'.$aula->id.'</td>';
                                ...
                                */
                                ...
                                if($valor_hora_aula->aplicar_categoria == 's'):
                                    echo '<td class="text-center" width="5%">R$ '.number_format($aula->valor_hora_aula*$colega->instrutor_categoria, 2, ',', '.').'</td>';

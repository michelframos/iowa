...
<script src="js/rel-colegas.js"></script>

<!-- Start Content -->
<div class="espaco20"></div>
<div class="titulo">
    <i class="material-icons texto-laranja pmd-md">description</i>
    <h1>Relatório de Colegas IOWA</h1>
</div>
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <form action="" name="formPesquisa" id="formPesquisa" method="post">
        ...
        <?php if(Permissoes::find_by_id_usuario_and_tela_and_imp(idUsuario(), 'Relatório - Colegas IOWA', 's')): ?>

...
if($dados['acao'] == 'listar-turmas'):
    ...
    $turmas = Turmas::find_by_sql("select turmas.id as id_turma, turmas.id_unidade, turmas.nome, turmas.status, matriculas.* from matriculas inner join turmas on matriculas.id_turma = turmas.id where responsavel_pedagogico = 2 and id_empresa_pedagogico = '".$id_empresa."' and turmas.status = 'a' GROUP BY turmas.id;");
...
if($dados['acao'] == 'gerar-relatorio'):
    ...
    */
    ...
    $turmas = Turmas::find_by_sql("
        ...
        tur.status = 'a' and
        mat.`status` = 'a' and 
        mat.responsavel_pedagogico = '2' and
        mat.id_empresa_pedagogico like '".$id_empresa."'

<?php
    ...
    verificaPermissao(idUsuario(), 'Relatório - Inativação de Aluno', 'c', 'index');

?>
<script src="js/jQuery.print.min.js"></script>
<script src="js/rel-cancelamentos.js"></script>

<!-- Start Content -->
<div class="espaco20"></div>
<div class="titulo">
    <i class="material-icons texto-laranja pmd-md">description</i>
    <h1>Inativação de Matrículas</h1>
</div>
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <form action="" name="formPesquisa" id="formPesquisa" method="post">
        ...
        <?php if(Permissoes::find_by_id_usuario_and_tela_and_imp(idUsuario(), 'Relatório - Inativação de Aluno', 's')): ?>

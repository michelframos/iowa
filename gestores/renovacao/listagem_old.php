        ...
        <table class="table pmd-table table-hover">
            ...
            if(isset($_POST['mes'])):
                ...
                if(!empty($_POST['id_motivo'])):
                    $motivo = 'id_motivo = '.filter_input(INPUT_POST, 'id_motivo', FILTER_SANITIZE_NUMBER_INT);
                else:
                    $motivo = '(id_motivo is null or id_motivo = 0)';
                endif;
                ...
                if(!empty($matriculas)):
                    foreach($matriculas as $matricula):
                        ...
                        try{
                            $parcela = V_Parcelas2::find(array('conditions' => array('id_matricula = ? and nome like ? and '.$motivo.'', $matricula->id, $nome_aluno), 'order' => 'data_vencimento desc', 'limit' => 1));

    ...
    <div class="table-responsive">
        <table class="table pmd-table table-hover">
            ...
            if(isset($_POST['valor_pesquisa'])):
                ...
                $registros = Usuarios::all(array('conditions' => array('nome like ? or login like ?', '%'.$valor_pesquisa.'%', '%'.$valor_pesquisa.'%'),'order' => 'nome asc'));
                if(!empty($registros)):
                    foreach($registros as $registro):

                        try{
                            $categoria = Perfis::find($registro->id_perfil);
                        ...
                        echo '<td data-title="Perfil">'.$categoria->perfil.'</td>';

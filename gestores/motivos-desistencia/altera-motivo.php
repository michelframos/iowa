...
$registro = Motivos_Desistencia::find($id);

?>

<script src="js/motivos-desistencia.js"></script>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Já exite um Motivo de Desistência com este nome.</p>
            </div>
...
<div class="titulo">
    <i class="material-icons texto-laranja pmd-md">thumb_down</i>
    <h1>Cadastro / Alteração de Motivo de Desistência</h1>
</div>
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <form action="" name="formDados" id="formDados" method="post" style="max-width: 600px;">
        ...
        <div class="form-group pmd-textfield pmd-textfield-floating-label">
            <label for="regular1" class="control-label">Motivo</label>
            <input type="text" name="motivo" id="motivo" value="<?php echo $registro->motivo ?>" class="form-control" required><span class="pmd-textfield-focused"></span>
        </div>

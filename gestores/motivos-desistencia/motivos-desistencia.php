<?php
    ...
    verificaPermissao(idUsuario(), 'Motivos de Desistência', 'c', 'index');
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Confirma a exclusão deste Valor de Hora/Aula? Esta ação é irreversível! </p>
            </div>
...
<section class="pmd-card pmd-z-depth padding-10">
    ...
    <div class="espaco20"></div>
    <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-novo"> Novo Motivo de Desistência</a>
    <div class="espaco20"></div>

<?php
    ...
    //verificaPermissao(idUsuario(), 'Idiomas', 'c', 'inicio');

    /*Verificando Permissões*/
    verificaPermissao(idUsuario(), 'Idiomas', 'c', 'index');
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Confirma a exclusão deste idioma? Esta ação é irreversível! </p>
            </div>
...
<!-- Start Content -->
    ...
    <section class="pmd-card pmd-z-depth padding-10">
        ...
        <div class="espaco20"></div>
        <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-novo-idioma"> Novo Idioma</a>
        <div class="espaco20"></div>

...
<!-- Start Content -->
    ...
    <div class="titulo">
        <i class="material-icons texto-laranja pmd-md">translate</i>
        <h1>Cadastro / Alteração de Idioma</h1>
    </div>

    <section class="pmd-card pmd-z-depth padding-10">

        <div class="espaco20"></div>
        <a href="javascript:void(0);" class="btn btn-danger pmd-btn-raised" id="bt-voltar-idioma">Voltar</a>
        <div class="espaco20"></div>

        <form action="" name="formDados" id="formDados" method="post" style="max-width: 600px;">

            <div class="form-group pmd-textfield pmd-textfield-floating-label">
                <label for="regular1" class="control-label">Idioma</label>
                <input type="text" name="idioma" id="idioma" value="<?php echo $registro->idioma ?>" class="form-control" required><span class="pmd-textfield-focused"></span>
            </div>

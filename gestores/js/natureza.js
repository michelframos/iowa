$(function(){
    ...
    $('#bt-novo').click(function(){
        ...
        var dados = 'acao=novo';
        $.post('natureza/acoes.php', { dados: dados }, function(data){
            if(data.status == 'ok')
            {
                $('#content').load('natureza/altera-natureza.php', {id: data.id});
            }
    ...
    $('#pesquisar').click(function(){
        ...
        $.post('natureza/listagem.php', { valor_pesquisa: $('#valor_pesquisa').val() }, function(data){
            $('#listagem').html(data);
        });
    ...
    $('#voltar').click(function(){
        $('#content').load('natureza/natureza.php');
    });



    $('#listagem').on('click', '.bt-altera', function(){
        $('#content').load('natureza/altera-natureza.php', {id: $(this).attr('registro')});
    });

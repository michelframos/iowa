$(function(){
    ...
    $('#bt-novo').click(function(){
        ...
        var dados = 'acao=novo';
        $.post('fornecedores/acoes.php', { dados: dados }, function(data){
            if(data.status == 'ok')
            {
                $('#content').load('fornecedores/altera-fornecedor.php', {id: data.id});
            }
    ...
    $('#pesquisar').click(function(){
        ...
        $.post('fornecedores/listagem.php', { valor_pesquisa: $('#valor_pesquisa').val() }, function(data){
            $('#listagem').html(data);
        });
    ...
    $('#voltar').click(function(){
        $('#content').load('fornecedores/fornecedores.php');
    });



    $('#listagem').on('click', '.bt-altera', function(){
        $('#content').load('fornecedores/altera-fornecedor.php', {id: $(this).attr('registro')});
    });

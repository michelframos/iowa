...
$agencia=$boleto->agencia;//Numdaagencia,semdigito
$conta=$boleto->conta;//Numdaconta,semdigito
$convenio= '65838';//Númerodoconvênioindicadonofrontend
...
$agencia = formata_numero($boleto->agencia,4,0);
//conta é sempre 8 digitos
$conta = formata_numero($boleto->conta,8,0);
...
$convenio = formata_numero('65838',7,0);

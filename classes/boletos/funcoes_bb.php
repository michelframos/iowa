...
$nummoeda = "9";
$fator_vencimento = fator_vencimento($boleto_sistema->data_vencimento->format('d/m/Y'));

//valor tem 10 digitos, sem virgula
$valor = formata_numero(number_format($boleto_sistema->valor, 2, '', ''),10,0,"valor");
...
if ($dadosboleto["formatacao_convenio"] == "8") {
	$convenio = formata_numero($convenio[0],8,0,"convenio");
	// Nosso n�mero de at� 9 d�gitos
	$nossonumero = formata_numero($boleto_sistema->nosso_numero,9,0);
...
if ($dadosboleto["formatacao_convenio"] == "7") {
	$convenio = formata_numero($convenio[0],7,0,"convenio");
	// Nosso n�mero de at� 10 d�gitos
	$nossonumero = formata_numero($boleto_sistema->nosso_numero,10,0);
	$dv=modulo_11("$codigobanco$nummoeda$fator_vencimento$valor$livre_zeros$convenio$nossonumero$carteira");
	$linha="$codigobanco$nummoeda$dv$fator_vencimento$valor$livre_zeros$convenio$nossonumero$carteira";
...
if ($dadosboleto["formatacao_convenio"] == "6") {
	$convenio = formata_numero($convenio[0],6,0,"convenio");
	
	if ($dadosboleto["formatacao_nosso_numero"] == "1") {
		
		// Nosso n�mero de at� 5 d�gitos
		$nossonumero = formata_numero($boleto->nosso_numero,5,0);
	...
	if ($dadosboleto["formatacao_nosso_numero"] == "2") {
		...
		$nservico = "21";
		$nossonumero = formata_numero($boleto->nosso_numero,17,0);

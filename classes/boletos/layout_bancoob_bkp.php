		...
		<tr><td class="last_line" rowspan="6">
			...
			<tr class="campos">
				<td class="instrucoes" rowspan="5">
					<p><?php echo $dadosboleto["demonstrativo1"].'1'; ?></p>
					<p><?php echo $dadosboleto["demonstrativo2"].'2'; ?></p>
					<p><?php echo $dadosboleto["demonstrativo3"].'3'; ?></p>
					<p><?php echo $dadosboleto["instrucoes1"].'4'; ?></p>
					<p><?php echo $dadosboleto["instrucoes2"].'5'; ?></p>
					<p><?php echo $dadosboleto["instrucoes3"].'6'; ?></p>
					<p><?php echo $dadosboleto["instrucoes4"].'7'; ?></p>
				</td>
			</tr>
			</tbody>
			</table>
